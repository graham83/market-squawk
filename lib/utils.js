...
export function formatTimeET(isoDateString) {
  ...
  return timeString === '24:00' ? '00:00' : timeString;
}
...
/**
 * Create an AbortSignal with timeout that works across Node.js versions
 * @param {number} ms - Timeout in milliseconds
 * @returns {AbortSignal} Abort signal that triggers after timeout
 */
export function createTimeoutSignal(ms) {
  // Use AbortSignal.timeout if available (Node 16.14+)
